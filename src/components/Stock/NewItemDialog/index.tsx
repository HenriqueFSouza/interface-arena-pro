...
import { createStockItemSchema, CreateStockItemSchema } from "@/schemas/create-stock-item-schema"
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Preencha os dados do novo item. Clique em salvar quando terminar.</DialogDescription>
                </DialogHeader>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} value={field.value}>
                                            ...
                                            <SelectContent>
                                                <SelectItem value={UnitMeasure.UNIT}>Unidade</SelectItem>
                                                <SelectItem value={UnitMeasure.KILOGRAM}>Quilo</SelectItem>

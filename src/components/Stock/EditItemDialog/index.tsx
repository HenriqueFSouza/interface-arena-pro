...
import { editStockItemSchema, EditStockItemSchema } from "@/schemas/edit-stock-item-schema"
...
export function EditItemDialog({ item }: EditItemDialogProps) {
    ...
    async function onSubmit(values: EditStockItemSchema) {
        updateItem({
            id: item.id, data: {
                ...values,
                unitPrice: values.totalPrice && values.quantity ? values.totalPrice / values.quantity : undefined,
            }
        }, {
            onSuccess: () => {
                setOpen(false)
        ...
        <Dialog open={open} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Altere os dados do item. Clique em salvar quando terminar.</DialogDescription>
                </DialogHeader>
